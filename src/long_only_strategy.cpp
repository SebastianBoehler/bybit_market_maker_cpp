...
LongOnlyMarketMakerStrategy::LongOnlyMarketMakerStrategy(std::string symbol,
                                                         InstrumentMeta meta,
                                                         double budget_usd,
    ...
    : settings_{symbol, meta, StrategyMode::LongOnly, budget_usd, min_spread_bps, spread_factor,
...
void LongOnlyMarketMakerStrategy::on_snapshot(const MarketDataSnapshot &snapshot,
